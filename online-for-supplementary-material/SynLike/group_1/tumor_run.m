...
problem = 'tumor';
group = 1; % the treatment group to fit 
...
figure
subplot(2,2,1)
hist(postpredcheck(:,21))
vline(obssummaries(21))
xlabel('s_{inter}^1')
% second inter-subjects summary
subplot(2,2,2)
hist(postpredcheck(:,22))
vline(obssummaries(22))
xlabel('s_{inter}^2')
% third inter-subjects summary
subplot(2,2,3)
hist(postpredcheck(:,23))
vline(obssummaries(23))
xlabel('s_{inter}^3')
